...
conn=ibm_db.connect("database=bludb;hostname=1bbf73c5-d84a-4bb0-85b9-ab1a4348f4a4.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;port=32286;protocol=tcpip;uid=ztq31022;pwd=sEL23UMAvjEpMkuA;security=SSL","","")
print(conn)
...
@app.route('/')
def home():
    message = "Welcome To Customer Care"
